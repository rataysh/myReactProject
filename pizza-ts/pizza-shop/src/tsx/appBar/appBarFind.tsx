...
export default function AppBarFind() {
    ...
    useEffect(()=>{
        ...
        setColorFocusedFind(colorFocusedFindFlag = false)
    })

    return (
        <div className="flex place-items-center justify-between space-x-4">
            <form className={colorFocusedFindFlag 
            ? "hover md:appBarFindInput md:border-orange-500" 
            : "hover md:appBarFindInput md:border-orange-200"
                } >
